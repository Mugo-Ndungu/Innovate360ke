...
!(function (e, t) {
  ...
  function w(e, o) {
    if ("viewport" === o) {
      ...
      o &&
        ...
        (e = x((e = { width: p, height: a, x: l + f(e), y: u })));
  ...
  function k(e, n) {
    ...
    var c = r.altBoundary,
      p = void 0 !== c && c;
    r = D(
      "number" != typeof (r = void 0 === (r = r.padding) ? 0 : r) ? r : P(r, q)
    );
  ...
  function W(e) {
    ...
    if (p) {
      ...
      v === n(r) && (v = s(r)),
        "top" === i &&
          ((h = "bottom"), (l -= v.clientHeight - o.height), (l *= c ? 1 : -1)),
        "left" === i &&
          ((m = "right"), (e -= v.clientWidth - o.width), (e *= c ? 1 : -1));
    }
    return (
      (r = Object.assign({ position: f }, p && _)),
      c
        ? Object.assign(
            Object.assign({}, r),
            {},
        ...
        fn: function (e) {
          ...
          if (((e = e.name), !t.modifiersData[e]._skip)) {
            ...
            for (var h = d[0], g = 0; g < d.length; g++) {
              ...
              if (
                ((O = x ? (O ? "right" : "left") : O ? "bottom" : "top"),
                n[w] > i[w] && (O = A(O)),
                (w = A(O)),
                (x = []),
                r && x.push(0 >= j[v]),
                o && x.push(0 >= j[O], 0 >= j[w]),
                x.every(function (e) {
                  return e;
                }))
              ) {
